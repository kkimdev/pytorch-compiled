...
auto registerer = torch::RegisterOperators()
  ...
  .op(torch::RegisterOperators::options()
    ...
    .impl_unboxedOnlyKernel<void (const Tensor &, Tensor &, Tensor &, int64_t), &CUDAType::_cummax_helper>(DispatchKey::CUDATensorId)
    .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
  .op(torch::RegisterOperators::options()
    .schema("aten::_cummin_helper(Tensor self, Tensor(a!) values, Tensor(b!) indices, int dim) -> ()")
    .impl_unboxedOnlyKernel<void (const Tensor &, Tensor &, Tensor &, int64_t), &CUDAType::_cummin_helper>(DispatchKey::CUDATensorId)
    .aliasAnalysis(c10::AliasAnalysisKind::FROM_SCHEMA))
  .op(torch::RegisterOperators::options()
